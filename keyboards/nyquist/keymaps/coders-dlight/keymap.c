...
[_LOWER] = LAYOUT( \
  ...
  KC_F7, KC_F8, KC_F9, KC_F110, KC_F11, KC_F12, KC_COMMA, KC_DOT, KC_KP_4, KC_KP_5, KC_KP_6, KC_DELETE, \
  KC_ESCAPE, KC_MPRV, KC_MPLY, KC_MNXT, KC_VOLU,  _______, KC_LBRACKET, KC_RBRACKET, KC_KP_1, KC_KP_2, KC_KP_3, KC_NUMLOCK, \
  KC_LSHIFT, _______, _______, _______, KC_VOLD,  _______, KC_BSLASH, KC_SCOLON, KC_KP_EQUAL, KC_KP_0, KC_KP_DOT, KC_ENTER, \
